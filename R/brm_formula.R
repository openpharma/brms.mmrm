...
#'   [brm_data()] dataset or an informative prior scenario.
...
#'   Functions like [brm_scenario_successive_cells()]
...
#' @export
brm_formula_validate.brms_mmrm_formula_scenario <- function(formula) {
  assert(
    formula,
    inherits(., "brms_mmrm_formula"),
    inherits(., "brmsformula"),
