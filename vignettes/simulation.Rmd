...
#>  7       NA FALSE   group_1 time_3 patien…      1.04      -0.779 absent  absent 
...
#>    response missing group   time   patient biomarker1 biomarker2 status1 status2
#>       <dbl> <lgl>   <chr>   <chr>  <chr>        <dbl>      <dbl> <chr>   <chr>  
#>  1   -1.47  FALSE   group_1 time_1 patien…      0.328     -0.655 present absent 
#>  2   NA     TRUE    group_1 time_2 patien…      0.328     -0.655 present absent 
#>  3   NA     TRUE    group_1 time_3 patien…      0.328     -0.655 present absent 
#>  4   NA     TRUE    group_1 time_4 patien…      0.328     -0.655 present absent 
#>  5    2.53  FALSE   group_1 time_1 patien…      1.04      -0.779 absent  absent 
#>  6   -0.739 FALSE   group_1 time_2 patien…      1.04      -0.779 absent  absent 
#>  7    3.41  FALSE   group_1 time_3 patien…      1.04      -0.779 absent  absent 
#>  8   NA     TRUE    group_1 time_4 patien…      1.04      -0.779 absent  absent 
#>  9    6.93  FALSE   group_1 time_1 patien…      0.717     -0.954 present absent 
#> 10   -2.07  FALSE   group_1 time_2 patien…      0.717     -0.954 present absent 
#> # ℹ 790 more rows
```
