...
#>  5 PT3     VIS1   PBO   Black or Afri… Fema…    43.5  NA    0.682      1  0.576 
#>  6 PT3     VIS2   PBO   Black or Afri… Fema…    43.5  36.0  0.892      2 -0.305 
#>  7 PT3     VIS3   PBO   Black or Afri… Fema…    43.5  NA    0.128      3  1.51  
#>  8 PT3     VIS4   PBO   Black or Afri… Fema…    43.5  37.2  0.222      4  0.390 
#>  9 PT5     VIS1   PBO   Black or Afri… Male     43.6  32.3  0.411      1 -0.0162
#> 10 PT5     VIS2   PBO   Black or Afri… Male     43.6  NA    0.422      2  0.944 
#> # ℹ 790 more rows
```
...
#> #   nuisance_SEX_Male <dbl>, USUBJID <fct>, AVISIT <ord>, ARMCD <fct>,
#> #   RACE <fct>, SEX <fct>, FEV1_BL <dbl>, FEV1 <dbl>, WEIGHT <dbl>,
...
Note: the parameterization includes no intercept in the model. To include an intercept, set `intercept = TRUE` in `brm_archetype_successive_cells()`.


``` r
summary(brm_archetype_successive_cells(data, intercept = TRUE))
#> # This is the "successive cells" informative prior archetype in brms.mmrm.
#> # The following equations show the relationships between the
#> # marginal means (left-hand side) and fixed effect parameters
#> # (right-hand side).
...
#> #   TRT:VIS2 = x_PBO_VIS1 + x_TRT_VIS1 + x_TRT_VIS2
#> #   TRT:VIS3 = x_PBO_VIS1 + x_TRT_VIS1 + x_TRT_VIS2 + x_TRT_VIS3
#> #   TRT:VIS4 = x_PBO_VIS1 + x_TRT_VIS1 + x_TRT_VIS2 + x_TRT_VIS3 + x_TRT_VIS4
```
