...
#> #   nuisance_status1_absent <dbl>, nuisance_status2_present <dbl>, nuisance_baseline.timetime_2 <dbl>,
#> #   nuisance_baseline.timetime_3 <dbl>, nuisance_baseline.timetime_4 <dbl>, patient <chr>, time <chr>,
#> #   change <dbl>, missing <lgl>, baseline <dbl>, group <chr>, biomarker1 <dbl>, biomarker2 <dbl>,
#> #   status1 <chr>, status2 <chr>
```
...
#> [4] "nuisance_status2_present"     "nuisance_baseline.timetime_2" "nuisance_baseline.timetime_3"
...
#>  student_t(4, 0.98, 2.37)     b x_group_1_time_2                       <NA> <NA>   user
#>  student_t(4, 1.82, 3.32)     b x_group_1_time_3                       <NA> <NA>   user
#>  student_t(4, 2.35, 4.41)     b x_group_1_time_4                       <NA> <NA>   user
#>  student_t(4, 0.31, 2.22)     b x_group_2_time_2                       <NA> <NA>   user
#>  student_t(4, 1.94, 2.85)     b x_group_2_time_3                       <NA> <NA>   user
#>  student_t(4, 2.33, 3.41)     b x_group_2_time_4                       <NA> <NA>   user
```
...
#>  student_t(4, 1.94, 2.85)     b             x_group_2_time_3                       <NA> <NA>   user
#>  student_t(4, 2.33, 3.41)     b             x_group_2_time_4                       <NA> <NA>   user
#>  student_t(4, 2.17, 4.86)     b nuisance_baseline.timetime_2                       <NA> <NA>   user
#>  student_t(4, 3.22, 5.25)     b nuisance_baseline.timetime_3                       <NA> <NA>   user
#>  student_t(4, 2.53, 5.75)     b nuisance_baseline.timetime_4                       <NA> <NA>   user
```
...
#>   prior   class                         coef group resp  dpar nlpar lb ub       source
#>  (flat)       b                                                                default
#>  (flat)       b nuisance_baseline.timetime_2                              (vectorized)
#>  (flat)       b nuisance_baseline.timetime_3                              (vectorized)
#>  (flat)       b nuisance_baseline.timetime_4                              (vectorized)
#>  (flat)       b          nuisance_biomarker1                              (vectorized)
#>  (flat)       b          nuisance_biomarker2                              (vectorized)
#>  (flat)       b      nuisance_status1_absent                              (vectorized)
#>  (flat)       b     nuisance_status2_present                              (vectorized)
#>  (flat)       b             x_group_1_time_2                              (vectorized)
#>  (flat)       b             x_group_1_time_3                              (vectorized)
#>  (flat)       b             x_group_1_time_4                              (vectorized)
#>  (flat)       b             x_group_2_time_2                              (vectorized)
#>  (flat)       b             x_group_2_time_3                              (vectorized)
#>  (flat)       b             x_group_2_time_4                              (vectorized)
