...
data
#> # A tibble: 800 × 6
#>     FEV1 ARMCD AVISIT USUBJID WEIGHT SEX   
#>    <dbl> <chr> <chr>  <fct>    <dbl> <fct> 
#>  1  NA   PBO   VIS1   PT2      0.465 Male  
#>  2  31.5 PBO   VIS2   PT2      0.233 Male  
#>  3  36.9 PBO   VIS3   PT2      0.360 Male  
#>  4  48.8 PBO   VIS4   PT2      0.507 Male  
#>  5  NA   PBO   VIS1   PT3      0.682 Female
#>  6  36.0 PBO   VIS2   PT3      0.892 Female
#>  7  NA   PBO   VIS3   PT3      0.128 Female
#>  8  37.2 PBO   VIS4   PT3      0.222 Female
#>  9  32.3 PBO   VIS1   PT5      0.411 Male  
#> 10  NA   PBO   VIS2   PT5      0.422 Male  
#> # ℹ 790 more rows
```
...
#> 10          1          1          0          0          0          0          0          0
#> # ℹ 790 more rows
#> # ℹ 8 more variables: nuisance_WEIGHT <dbl>, nuisance_SEX_Male <dbl>, USUBJID <fct>,
#> #   AVISIT <chr>, FEV1 <dbl>, ARMCD <chr>, WEIGHT <dbl>, SEX <fct>
```
