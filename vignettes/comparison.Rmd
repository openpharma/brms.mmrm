...
#> cortime(VIS1,VIS2)     0.36      0.08     0.19     0.51 1.00    50794    24901
#> cortime(VIS1,VIS3)     0.14      0.10    -0.06     0.33 1.00    52409    25283
#> cortime(VIS2,VIS3)     0.04      0.10    -0.16     0.23 1.00    51184    22999
#> cortime(VIS1,VIS4)     0.17      0.11    -0.06     0.38 1.00    51766    25605
#> cortime(VIS2,VIS4)     0.11      0.09    -0.07     0.28 1.00    54864    26034
#> cortime(VIS3,VIS4)     0.01      0.10    -0.19     0.21 1.00    49233    23408
#> 
#> Population-Level Effects: 
#>                            Estimate Est.Error l-95% CI u-95% CI Rhat Bulk_ESS
#> Intercept                     24.35      1.42    21.57    27.11 1.00    45432
#> FEV1_BL                       -0.84      0.03    -0.89    -0.79 1.00    58803
#> AVISITVIS2                     4.78      0.81     3.18     6.39 1.00    32507
#> AVISITVIS3                    10.36      0.83     8.74    11.99 1.00    31267
#> AVISITVIS4                    15.20      1.33    12.61    17.78 1.00    36091
#> RACEBlackorAfricanAmerican     1.41      0.58     0.27     2.56 1.00    47128
#> RACEWhite                      5.45      0.62     4.23     6.66 1.00    48755
#> SEXFemale                      0.34      0.51    -0.65     1.34 1.00    52063
#> AVISITVIS1:ARMCDTRT            3.98      1.06     1.91     6.07 1.00    32937
#> AVISITVIS2:ARMCDTRT            3.94      0.81     2.34     5.55 1.00    51298
#> AVISITVIS3:ARMCDTRT            2.98      0.68     1.66     4.32 1.00    54622
#> AVISITVIS4:ARMCDTRT            4.39      1.69     1.08     7.68 1.00    46192
#> sigma_AVISITVIS1               1.83      0.06     1.71     1.95 1.00    50885
#> sigma_AVISITVIS2               1.59      0.06     1.47     1.71 1.00    50752
#> sigma_AVISITVIS3               1.33      0.06     1.21     1.45 1.00    55364
#> sigma_AVISITVIS4               2.28      0.06     2.16     2.41 1.00    55598
#>                            Tail_ESS
#> Intercept                     26059
#> FEV1_BL                       24992
#> AVISITVIS2                    25040
#> AVISITVIS3                    25022
#> AVISITVIS4                    25391
#> RACEBlackorAfricanAmerican    25841
#> RACEWhite                     25195
#> SEXFemale                     25228
#> AVISITVIS1:ARMCDTRT           26231
#> AVISITVIS2:ARMCDTRT           25194
#> AVISITVIS3:ARMCDTRT           24340
#> AVISITVIS4:ARMCDTRT           24977
#> sigma_AVISITVIS1              24577
#> sigma_AVISITVIS2              24652
#> sigma_AVISITVIS3              24643
#> sigma_AVISITVIS4              25457
#> 
...
<td headers="bayes_estimate" class="gt_row gt_right">24.3493</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">4.7848</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">10.3631</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">15.1952</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">1.4117</td>
<td headers="freq_estimate" class="gt_row gt_right">1.4192</td>
<td headers="diff_estimate" class="gt_row gt_right">−0.0075</td>
<td headers="diff_relative_estimate" class="gt_row gt_right">−0.0053</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">racewhite</td>
<td headers="bayes_estimate" class="gt_row gt_right">5.4501</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">0.3433</td>
<td headers="freq_estimate" class="gt_row gt_right">0.3381</td>
<td headers="diff_estimate" class="gt_row gt_right">0.0052</td>
<td headers="diff_relative_estimate" class="gt_row gt_right">0.0155</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis1:armcdtrt</td>
<td headers="bayes_estimate" class="gt_row gt_right">3.9798</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">2.9844</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">4.3942</td>
<td headers="freq_estimate" class="gt_row gt_right">4.4040</td>
<td headers="diff_estimate" class="gt_row gt_right">−0.0098</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">4.9137</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">3.7762</td>
<td headers="freq_estimate" class="gt_row gt_right">3.7153</td>
<td headers="diff_estimate" class="gt_row gt_right">0.0609</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">9.7987</td>
<td headers="freq_estimate" class="gt_row gt_right">9.6417</td>
<td headers="diff_estimate" class="gt_row gt_right">0.1569</td>
...
<td headers="diff_relative_estimate" class="gt_row gt_right">−0.0739</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">correlation_vis2_vis3</td>
<td headers="bayes_estimate" class="gt_row gt_right">0.0392</td>
<td headers="freq_estimate" class="gt_row gt_right">0.0430</td>
<td headers="diff_estimate" class="gt_row gt_right">−0.0038</td>
<td headers="diff_relative_estimate" class="gt_row gt_right">−0.0886</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">correlation_vis1_vis4</td>
<td headers="bayes_estimate" class="gt_row gt_right">0.1668</td>
<td headers="freq_estimate" class="gt_row gt_right">0.1802</td>
<td headers="diff_estimate" class="gt_row gt_right">−0.0133</td>
...
<td headers="bayes_estimate" class="gt_row gt_right">0.1101</td>
<td headers="freq_estimate" class="gt_row gt_right">0.1178</td>
<td headers="diff_estimate" class="gt_row gt_right">−0.0077</td>
<td headers="diff_relative_estimate" class="gt_row gt_right">−0.0650</td></tr>
...
<td headers="diff_relative_estimate" class="gt_row gt_right">−0.1345</td></tr>
  </tbody>
...
<table class="gt_table" data-quarto-disable-processing="false" data-quarto-bootstrap="false">
  ...
  <tbody class="gt_table_body">
    <tr><td headers="variable" class="gt_row gt_left">intercept</td>
<td headers="bayes_se" class="gt_row gt_right">1.4155</td>
<td headers="freq_se" class="gt_row gt_right">1.4075</td>
<td headers="diff_se" class="gt_row gt_right">0.0079</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0056</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">fev1_bl</td>
...
<td headers="diff_relative_se" class="gt_row gt_right">0.0109</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis2</td>
<td headers="bayes_se" class="gt_row gt_right">0.8146</td>
<td headers="freq_se" class="gt_row gt_right">0.7985</td>
<td headers="diff_se" class="gt_row gt_right">0.0161</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0202</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis3</td>
<td headers="bayes_se" class="gt_row gt_right">0.8275</td>
<td headers="freq_se" class="gt_row gt_right">0.8132</td>
<td headers="diff_se" class="gt_row gt_right">0.0143</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0176</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis4</td>
<td headers="bayes_se" class="gt_row gt_right">1.3322</td>
<td headers="freq_se" class="gt_row gt_right">1.3086</td>
<td headers="diff_se" class="gt_row gt_right">0.0236</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0180</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">raceblackorafricanamerican</td>
<td headers="bayes_se" class="gt_row gt_right">0.5836</td>
<td headers="freq_se" class="gt_row gt_right">0.5787</td>
<td headers="diff_se" class="gt_row gt_right">0.0049</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0084</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">racewhite</td>
<td headers="bayes_se" class="gt_row gt_right">0.6196</td>
...
<td headers="diff_relative_se" class="gt_row gt_right">0.0054</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">sexfemale</td>
<td headers="bayes_se" class="gt_row gt_right">0.5097</td>
<td headers="freq_se" class="gt_row gt_right">0.4927</td>
<td headers="diff_se" class="gt_row gt_right">0.0169</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0343</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis1:armcdtrt</td>
<td headers="bayes_se" class="gt_row gt_right">1.0635</td>
<td headers="freq_se" class="gt_row gt_right">1.0454</td>
<td headers="diff_se" class="gt_row gt_right">0.0181</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0173</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis2:armcdtrt</td>
<td headers="bayes_se" class="gt_row gt_right">0.8150</td>
<td headers="freq_se" class="gt_row gt_right">0.8135</td>
<td headers="diff_se" class="gt_row gt_right">0.0015</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0018</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis3:armcdtrt</td>
<td headers="bayes_se" class="gt_row gt_right">0.6757</td>
<td headers="freq_se" class="gt_row gt_right">0.6657</td>
<td headers="diff_se" class="gt_row gt_right">0.0100</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0150</td></tr>
    <tr><td headers="variable" class="gt_row gt_left">avisitvis4:armcdtrt</td>
<td headers="bayes_se" class="gt_row gt_right">1.6851</td>
<td headers="freq_se" class="gt_row gt_right">1.6605</td>
<td headers="diff_se" class="gt_row gt_right">0.0246</td>
<td headers="diff_relative_se" class="gt_row gt_right">0.0148</td></tr>
  </tbody>
