...
This vignette explains how to incorporate a subgroup variable into an MMRM using the `brms.mmrm` package. Here, we assume the subgroup variable has already been selected in advance. Subgroup variable selection is a thorough process that requires deep domain knowledge and careful adjustments for multiplicity, all of which belong outside the scope of this vignette. The subgroup MMRM analysis described below should not take place until there is sufficient prior justification for the choice of the subgroup variable.
