...
We use the FEV1 data from the `mmrm` package, which contains simulated measurements of forced expiratory volume in 1 second (FEV1) for virtual patients with chronic obstructive pulmonary disease (COPD) at multiple visits.
...
#> 10          0          1          0          0          0          0          0
#> # ℹ 790 more rows
#> # ℹ 12 more variables: x_TRT_VIS4 <int>, USUBJID <fct>, AVISIT <ord>, ARMCD <fct>,
#> #   RACE <fct>, SEX <fct>, FEV1_BL <dbl>, FEV1 <dbl>, WEIGHT <dbl>, VISITN <int>,
